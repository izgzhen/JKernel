...
extern void alloc_frame(page_t*, bool, bool);
...
void initialise_tasking() {
    ...
    current_task->esp = current_task->ebp = NULL;
    current_task->eip = NULL;
...
void move_stack(void *new_stack_start, uint32_t size) {
       ...
       i -= 0x1000)
  {
    ...
    alloc_frame( get_page(i, DO_MAKE, current_directory), USER_MODE , WRITABLE);
  }
...
int32_t fork() {
    ...
    new_task->esp = new_task->ebp = NULL;
    new_task->eip = NULL;
